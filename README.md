...
[Features](#-features) • [Quick Start](#-quick-start) • [Development](#-development) • [Tech Stack](#-tech-stack) • [Documentation](#-documentation)
...
- 🗺️ [Vue Router Documentation](https://router.vuejs.org/)
...
**[⬆ back to top](#-iwak-classification)**
